...
#
# On success, it will define: > LIBNX_FOUND        - The system has libnx >
# LIBNX_INCLUDE_DIRS - The libnx include directories > LIBNX_LIBRARIES    - The
# static libnx libraries
#
...
# ~~~
#
# By default, CMake will look for libnx in $DEVKITPRO/libnx. If you want to use
# a custom fork, you need to override the `LIBNX` variable within CMake before
# this file is used.
...
if(NOT SWITCH)
  message(
    FATAL_ERROR
      "This helper can only be used when cross-compiling for the Switch."
  )
endif()
...
find_package_handle_standard_args(
  LIBNX DEFAULT_MSG LIBNX_INCLUDE_DIR LIBNX_LIBRARY
)
...
if(LIBNX_FOUND)
  ...
  set_target_properties(
    switch::libnx
    PROPERTIES IMPORTED_LOCATION "${LIBNX_LIBRARY}"
