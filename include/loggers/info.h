...
#ifndef AXOLOGL_INFO_H
#define AXOLOGL_INFO_H
#include "logger.h"
...
namespace axologl::logger
{
    ...
    {
        static constexpr LogLevel logLevel = Info;
        static constexpr std::string_view prefix = "INFO";
        static constexpr std::string_view ansiCode = "\033[34m";
